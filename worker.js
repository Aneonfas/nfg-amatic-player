...
@media (max-width:900px){.nav-inner{align-items:flex-start;flex-direction:column;padding:14px 0}.nav-links{flex-wrap:wrap;gap:10px 14px}.hero-grid,.download-grid,.grid2,.grid3{grid-template-columns:1fr}.hero-grid{gap:28px}.section-head{align-items:flex-start;flex-direction:column;gap:8px}h1{font-size:2.7rem}}@media (max-width:520px){.container,.lead,.section-copy,.badges,.hero-media{width:calc(100vw - 20px)!important;max-width:calc(100vw - 20px)!important}.hero{padding-top:34px}h1{font-size:2.25rem}h2{font-size:1.55rem}.lead{font-size:1.05rem}.actions,.actions .btn{width:calc(100vw - 20px)!important;max-width:calc(100vw - 20px)!important}.pill{max-width:100%;white-space:normal}.spec-row{grid-template-columns:1fr;gap:4px}}
</style>
</head>
<body>
