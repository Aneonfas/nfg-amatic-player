...
@media (max-width:900px){.nav-inner{align-items:flex-start;flex-direction:column;padding-top:14px;padding-bottom:14px}.nav-links{flex-wrap:wrap;gap:10px 14px}.hero-grid,.download-grid,.grid2,.grid3{grid-template-columns:1fr}.hero-grid{gap:28px}.section-head{align-items:flex-start;flex-direction:column;gap:8px}h1{font-size:2.7rem}}@media (max-width:520px){.container{padding:0 10px}.hero{padding-top:34px}h1{font-size:2.25rem}h2{font-size:1.55rem}.lead,.section-copy{width:100%;max-width:340px}.badges{width:100%;max-width:300px}.hero-media{width:100%;max-width:100%}.lead{font-size:1.05rem}.actions,.actions .btn{width:100%}.pill{max-width:100%;white-space:normal}.spec-row{grid-template-columns:1fr;gap:4px}}
</style>
</head>
<body>
