...
.hero{padding:56px 0 42px}.hero-grid{display:grid;grid-template-columns:minmax(0,.92fr) minmax(420px,1.08fr);align-items:center;gap:46px}.kicker{display:inline-flex;align-items:center;min-height:28px;margin-bottom:16px;border:1px solid var(--line);border-radius:8px;padding:4px 10px;background:var(--paper);color:#0b514c;font-size:.84rem;font-weight:700}h1,h2,h3,p{margin-top:0}h1{margin-bottom:18px;font-size:3.8rem;line-height:.98;letter-spacing:0}h2{margin-bottom:16px;font-size:2rem;line-height:1.12;letter-spacing:0}h3{margin-bottom:10px;font-size:1.05rem;line-height:1.25;letter-spacing:0}.lead{max-width:620px;margin-bottom:26px;color:var(--muted);font-size:1.2rem;line-height:1.55}
